        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <div>
                    ...
                    <p>Summer School Camp LTD.<br />Providing reliable tech since 2020</p>
                    <p>132, Block-D/A , North Banani, Dhaka,Bangladesh-1204</p>
                </div>
                <div>
            ...
            <div>
                <footer className="footer footer-center p-4 bg-base-300 text-base-content">
                    <div>
                        <p>Copyright © 2023 - All right reserved by Summer School Ltd</p>
                    </div>
                </footer>
            </div>
        </div>
